...
class Category extends MY_Controller {
    ...
    public function lists() {
        ...
        extract($return_data);
        $recommends = $this->format_query('/recommend/manage', array('customer_type' => $customer_type, 'status' => C('status.common.success'), 'location_id' => $location_id, 'site_id' => $site_id));
        $data['recommends'] = [];
