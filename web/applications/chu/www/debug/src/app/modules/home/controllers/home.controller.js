...
angular
.module('dachuwang')
.controller('homeController', ['$scope', '$state' ,'$rootScope' ,'$http','$window','locationService','notifyService','categoryService','cateObj','daChuLocal', 'advService', 'req' , 'Lightbox' , 'posService' ,'userAuthService' ,function($scope, $state ,$rootScope, $http, $window, locationService, notifyService, categoryService, cateObj,daChuLocal, advService , req , Lightbox ,posService ,userAuthService) {
