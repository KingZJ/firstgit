...
angular
.module('dachuwang')
.controller('cartController', ["$scope", "$rootScope" , "$filter", "$cookieStore", "$window", "cartlist", "daChuDialog","req", "posService",'rpc', function($scope, $rootScope,$filter, $cookieStore, $window, cartlist, daChuDialog, req, posService , rpc) {
