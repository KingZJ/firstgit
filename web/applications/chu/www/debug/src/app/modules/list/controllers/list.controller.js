...
angular
.module('dachuwang')
.controller('padController',['$rootScope' ,'$location', '$window','$scope', '$stateParams','productService', 'categoryService', 'cartlist', 'Lightbox', function( $rootScope,$location, $window,$scope, $stateParams, productService, categoryService, cartlist, Lightbox) {
  // 商品列表
  // 分类获取
