...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <?php
        $current_url = $current_url.'?site_id='.$site_id;
        $customer_all = '';
        $customer_losting = '';
        $customer_new= '';
        $customer_save= '';
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="btn-group" role="group">
                <a href="<?php echo $current_url.'&tab_id=1&city_id='.$city_id ?>&menue_id=<?php echo $menue_id;?>" class="btn btn-default <?php echo $customer_all ?>" type="group">所有客户</a>
                <a href="<?php echo $current_url.'&tab_id=2&city_id='.$city_id ?>&menue_id=<?php echo $menue_id;?>" class="btn btn-default <?php echo $customer_losting ?>" type="group">将流失客户</a>
                <a href="<?php echo $current_url.'&tab_id=3&city_id='.$city_id ?>&menue_id=<?php echo $menue_id;?>" class="btn btn-default <?php echo $customer_new ?>" type="group">新客户</a>
                <a href="<?php echo $current_url.'&tab_id=4&city_id='.$city_id ?>&menue_id=<?php echo $menue_id;?>" class="btn btn-default <?php echo $customer_save ?>" type="group">留存客户</a>
                <a href="<?php echo $current_url.'&tab_id=5&city_id='.$city_id ?>&menue_id=<?php echo $menue_id;?>" class="btn btn-default <?php echo $customer_loyal ?>" type="group">忠实客户</a>
            </div>
            <span class="glyphicon glyphicon-question-sign pop" data-placement="bottom" data-content="
                ...
                <strong>忠实客户</strong>：7天前注册，下单频率≥0.5
                " aria-hidden="true">
            </span>
        </div>
    </div>
