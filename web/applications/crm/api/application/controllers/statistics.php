...
class Statistics extends MY_Controller {
    //允许用户请求的方法
    private $_action_list = array('get_statistics', 'get_total_statistics','get_query');
    private $_role_id_list = array(12,13,14,15);
    private $_role_id=NULL;
    //需要统计的数据
    private $_statistic_list = array(
        12 => array(
            'customer_num'           => '新增新注册客户数',
            'first_order_num'        => '新增首单数',
            'first_finish_order_num' => '新增已完成首单数'
        ),
        13 => array(
            'customer_num'           => '新增新注册客户数',
            'first_order_num'        => '新增首单数',
        ...
        14 => array(
            'customer_num'       => '新分配客户数',
            'order_customer_num' => '下单客户数',
            'not_order_customer_num' => '未下单客户数',
