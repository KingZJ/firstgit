...
angular
.module('dachuwang')
.controller('custormCtrl',['$scope','$modal', '$state', '$stateParams', '$cookieStore', '$window', '$interval', 'rpc', 'daChuDialog', 'geo', 'urlHistoryService', 'daChuLocal', function($scope, $modal, $state, $stateParams, $cookieStore, $window, $interval, rpc, dialog, geo, urlHistoryService, daChuLocal) {
  $scope.urls = null;
