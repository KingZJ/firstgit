...
class Coupon extends MY_Controller {
    ...
    public function info() {
        $data = $this->format_query('/coupon/info', $this->post);
        $data['info']['visiables'] = C('visiable');
    ...
    public function lists() {
        ...
        $data = $this->format_query('/coupon/lists', $this->post);
        $this->_return_json($data);
    }
    ...
    public function create() {
        ...
        $post = array(
            ...
            'category_ids' => empty($this->post['categories']) ? '' : $this->post['categories'],
            'product_ids' => empty($this->post['products']) ? '' : $this->post['products'],
